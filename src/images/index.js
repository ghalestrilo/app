export const avatars = {
  ...
  enemies: {
    robo: require("./temp/portraits/robo.png"),
    javali: require("./temp/portraits/javali.jpg"),
    ogro: require("./temp/portraits/ogro.jpg"),
    tigre: require("./temp/portraits/tigre.jpg"),
    troll: require("./temp/portraits/troll.jpg"),
