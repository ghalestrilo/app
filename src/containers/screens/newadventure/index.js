...
class NewAdventureScreen extends React.Component {
  ...
  isToggled = (value) => (value === this.state.switch);
...
const mapDispatchToProps = dispatch => ({
  addAdventure: adv => dispatch(addAdventure(adv))
})

export default connect(mapStateToProps, mapDispatchToProps)(NewAdventureScreen);
